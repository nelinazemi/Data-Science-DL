...
- ### 3- [Convolutional Neural Network:](https://github.com/nelinazemi/Data-Science-DL/tree/3ebbfb67e9e73cf87391486b668d486c4d273993/Convolutional%20Neural%20Network)
- This project is a complete pipeline for training a Convolutional Neural Network (CNN) on the CIFAR10 dataset. The CIFAR10 dataset is used, which is a popular dataset for image classification containing 10 different classes like cars, birds, dogs etc. The dataset is downloaded automatically and split into a training set and a test set. The code is well-structured and modular, making it easy to understand and modify if needed. It's a great starting point for anyone interested in getting hands-on experience with CNNs and image classification.
